# DeployWebService Method


Deploys the Tingen Web Service.
...
**C#**
``` C#
public static void DeployWebService(
	string configPath
)
```
**VB**
``` VB
Public Shared Sub DeployWebService ( 
...
``` C++
public:
static void DeployWebService(
	String^ configPath
)
```
**F#**
``` F#
static member DeployWebService : 
