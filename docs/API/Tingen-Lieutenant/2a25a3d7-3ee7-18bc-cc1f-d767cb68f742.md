...
Status messages related the source path.
...
**VB**
``` VB
Public Shared Function SourcePath ( 
	status As String
) As String
```
**C++**
...
#### Parameters
<dl><dt>  <a href="https://learn.microsoft.com/dotnet/api/system.string" target="_blank" rel="noopener noreferrer">String</a></dt><dd>The current status of the source path verification process.</dd></dl>
